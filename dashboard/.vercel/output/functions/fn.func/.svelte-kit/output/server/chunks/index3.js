import { o as onDestroy, l as get_store_value, q as createEventDispatcher, s as setContext, p as getContext, c as create_ssr_component, b as subscribe, h as compute_rest_props, i as spread, k as escape_object, a as add_attribute, v as validate_component, j as escape_attribute_value } from "./ssr.js";
import "dequal";
import { d as derived, w as writable, r as readable, a as readonly } from "./index.js";
import { o as is_void, c as cn } from "./index2.js";
import { nanoid } from "nanoid/non-secure";
import { b as tick } from "./updater.js";
...
function setCtx$1(props) {
  ...
  const dialog = { ...createDialog({ ...removeUndefined$1(props), role: "dialog" }), getAttrs };
...
function handleSnapPoints({ activeSnapPoint, snapPoints, drawerRef, overlayRef, fadeFromIndex, openTime }) {
  ...
  effect([activeSnapPoint, drawerRef], ([$activeSnapPoint, $drawerRef]) => {
    if ($activeSnapPoint && $drawerRef) {
      ...
      const newIndex = $snapPoints?.findIndex((snapPoint) => snapPoint === $activeSnapPoint) ?? null;
      if ($snapPointsOffset && newIndex && typeof $snapPointsOffset[newIndex] === "number") {
        snapToPoint($snapPointsOffset[newIndex]);
      }
    }
  });
  function snapToPoint(height) {
    tick().then(() => {
      const $snapPointsOffset = get_store_value(snapPointsOffset);
...
function createVaul(props) {
  ...
  const { snapPoints, fadeFromIndex, fixed, dismissible, modal, nested, shouldScaleBackground, scrollLockTimeout, closeThreshold } = options;
  ...
  function onNestedOpenChange(o) {
    ...
    if (!o && $drawerRef) {
      nestedOpenChangeTimer = setTimeout(() => {
        set($drawerRef, {
          transition: "none",
          transform: `translate3d(0, ${getTranslateY($drawerRef)}px, 0)`
        });
      }, 500);
    }
  }
...
const css = {
  code: '[data-vaul-drawer]{touch-action:none;transform:translate3d(0, 100%, 0);transition:transform 0.5s cubic-bezier(0.32, 0.72, 0, 1)}.vaul-dragging .vaul-scrollable{overflow-y:hidden !important}[data-vaul-drawer][data-vaul-drawer-visible="true"]{transform:translate3d(0, var(--snap-point-height, 0), 0)}[data-vaul-overlay]{opacity:0;transition:opacity 0.5s cubic-bezier(0.32, 0.72, 0, 1)}[data-vaul-overlay][data-vaul-drawer-visible="true"]{opacity:1}[data-vaul-drawer]::after{content:"";position:absolute;top:100%;background:inherit;background-color:inherit;left:0;right:0;height:200%}\n			[data-vaul-overlay][data-vaul-snap-points="true"]:not(\n					[data-vaul-snap-points-overlay="true"]\n				):not([data-state="closed"])\n		{opacity:0}\n			[data-vaul-overlay][data-vaul-snap-points-overlay="true"]:not(\n					[data-vaul-drawer-visible="false"]\n				)\n		{opacity:1}@keyframes fake-animation{from{}to{}}@media(hover: hover) and (pointer: fine){[data-vaul-drawer]{-webkit-user-select:none;-moz-user-select:none;user-select:none}}',
  map: null
};
const Root = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const { states: { keyboardIsOpen, activeSnapPoint: localActiveSnapPoint, drawerId, openDrawerIds: openDrawerIds2 }, methods: { closeDrawer, openDrawer }, options: { dismissible: localDismissible }, updateOption } = setCtx({
    defaultOpen: open,
...
const Content = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const { refs: { drawerRef }, states: { visible }, helpers: { getContentStyle }, methods: { onPress, onDrag, onRelease } } = getCtx();
    ...
    $$rendered = `${asChild ? `${validate_component(Dialog_trigger, "DialogPrimitive.Trigger").$$render(
      ...
      },
      {
        default: ({ builder: builder2 }) => {
          return `${validate_component(Trigger_wrapper, "TriggerWrapper").$$render($$result, { meltBuilder: builder2 }, {}, {
            default: ({ newBuilder }) => {
