import { l as get_store_value, p as getContext, s as setContext, c as create_ssr_component, b as subscribe, h as compute_rest_props, i as spread, k as escape_object, a as add_attribute, g as escape, v as validate_component, j as escape_attribute_value, e as each } from "./ssr.js";
import { dequal } from "dequal";
import { b as isHTMLElement, n as noop, i as isBrowser, r as isElement, t as isHTMLLabelElement, u as useClickOutside, v as useEscapeKeydown, f as executeCallbacks, w as isObject, m as disabledAttr, g as addMeltEventListener, s as styleToString, e as effect, x as hiddenInputAttrs, j as safeOnMount, k as kbd, y as isHTMLButtonElement, F as FIRST_LAST_KEYS, h as isElementDisabled, z as isHTMLInputElement, A as getDirectionalKeys, c as cn, C as cubicOut, o as is_void, p as flyAndScale } from "./index2.js";
import { g as getElementByMeltId, a as createElHelpers, b as builder, f as createLabel, c as createBitAttrs, d as createDispatcher } from "./events.js";
import { b as tick, a as overridable, t as toWritableStores, o as omit, s as stripValues, r as removeUndefined, g as getOptionUpdater } from "./updater.js";
...
const { name: name$1 } = createElHelpers("select");
function createSelect(props) {
  const listbox = createListbox({ ...props, builder: "select" });
  const group = builder(name$1("group"), {
    returned: () => {
      return (groupId) => ({
        role: "group",
  ...
  const groupLabel = builder(name$1("group-label"), {
    returned: () => {
      return (groupId) => ({
        id: groupId
      });
...
const Select = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const { states: { open: localOpen, selected: localSelected }, updateOption, ids } = setCtx$2({
    required,
    disabled,
    preventScroll,
    loop,
...
/**
 * @license lucide-svelte v0.306.0 - ISC
...
export {
  ...
  createSeparator as b,
  createTypeaheadSearch as c,
  derivedVisible as d,
  removeScroll as e,
  getNextFocusable as f,
  generateIds as g,
  handleRovingFocus as h,
  getPreviousFocusable as i,
  addHighlight as j,
  chunk as k,
  isValidIndex as l,
  getPositioningUpdater as m,
  Select_content as n,
  Select_item as o,
  Separator as p,
  Root$1 as q,
