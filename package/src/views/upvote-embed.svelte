...
<Modal open={open} onClose={onClose}>
    <span slot='header'>Feedback submitted for upvoting</span>
    <div slot='body'>
        <div class="space-y-4">
                                ...
                                <Table.Cell class="text-center">
                                    <span class="w-full">
                                        {#if sdk.isConnected()}
                                            ...
                                            {/if}
                                        {:else}
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#afafaf" d="M12.781 2.375c-.381-.475-1.181-.475-1.562 0l-8 10A1.001 1.001 0 0 0 4 14h4v7a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-7h4a1.001 1.001 0 0 0 .781-1.625zM15 12h-1v8h-4v-8H6.081L12 4.601L17.919 12z"/></svg>
                                        {/if}
                                    </span>
                                    <span class="w-full mt-3">{feedback.vote}</span>
                                </Table.Cell>
                            </Table.Row>
                        {/each}
                    </Table.Body>
